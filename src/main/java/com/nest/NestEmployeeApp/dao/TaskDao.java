...
public interface TaskDao extends CrudRepository<Task, Integer> {
    ...
    @Query(value = "SELECT e.`emp_code`, e.`emp_name`, t.`id`, t.`task_description`, t.`task_status`, t.`task_title`, t.`task_complete_date`, t.`task_date` FROM `task` AS t JOIN `employee` AS e ON t.emp_id = e.id", nativeQuery = true)
